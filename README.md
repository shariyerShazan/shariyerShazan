...
- Design microservice architectures, event-driven systems, and clean, maintainable APIs for modern applications.
- Deploy production workloads using Docker, Linux, Nginx, AWS, VPS, GitHub Actions, and CI/CD pipelines.
- Integrate AI-powered features using OpenAI, Claude, Ollama, and the Model Context Protocol (MCP).
- Comfortable with React and Next.js, while maintaining a backend-first engineering focus.
...
<p>
  ...
  <img src="https://img.shields.io/badge/DaisyUI-00B4A2?style=for-the-badge" />
